...
FLOD_update_matrix <- function(HBD, FLOD, f, q) {
    invisible(.Call(`_Fantasio2_FLOD_update_matrix`, HBD, FLOD, f, q))
}

FLOD_update_mmatrix <- function(HBD, FLOD, f, q) {
    invisible(.Call(`_Fantasio2_FLOD_update_mmatrix`, HBD, FLOD, f, q))
}
...
probaHBD_matrix <- function(p_A, PHBD_, p, submap, deltaDist, whichInds, a, f, epsilon) {
    invisible(.Call(`_Fantasio2_probaHBD_matrix`, p_A, PHBD_, p, submap, deltaDist, whichInds, a, f, epsilon))
}

probaHBD_mmatrix <- function(p_A, PHBD, p, submap, deltaDist, whichInds, a, f, epsilon) {
    invisible(.Call(`_Fantasio2_probaHBD_mmatrix`, p_A, PHBD, p, submap, deltaDist, whichInds, a, f, epsilon))
}
